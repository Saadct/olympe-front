...
const CGU = () => {
  return (
    <div className="div-cgu">
      ...
      <p>
        La Plateforme a pour objet de fournir un service de gestion d'événements, permettant aux Utilisateurs de créer, gérer, et s'inscrire à des événements.
      </p>

      <p><strong>3. Inscription</strong></p>
      <p>
        Pour accéder à certaines fonctionnalités de la Plateforme, l'Utilisateur doit créer un compte en fournissant des informations exactes et complètes. L'Utilisateur s'engage à maintenir à jour ces informations.
      </p>

      <p><strong>4. Utilisation de la Plateforme</strong></p>
      <p><strong>4.1 Comportement de l'Utilisateur</strong></p>
      <p>
        L'Utilisateur s'engage à :
      </p>
      <ul>
        <li>Utiliser la Plateforme conformément à la loi et aux présentes CGU.</li>
        <li>Ne pas utiliser la Plateforme pour des activités illégales ou non autorisées.</li>
        <li>Ne pas perturber ou tenter de perturber le fonctionnement de la Plateforme.</li>
      </ul>

      <p><strong>4.2 Contenu Utilisateur</strong></p>
      <p>
        L'Utilisateur est seul responsable du contenu qu'il publie sur la Plateforme. Il s'engage à ne pas publier de contenu :
      </p>
      <ul>
        <li>Qui soit diffamatoire, injurieux, obscène, pornographique, ou autrement illégal.</li>
        <li>Qui porte atteinte aux droits de propriété intellectuelle d'autrui.</li>
      </ul>
      ...
      <p>
        Les présentes CGU sont soumises au droit [français/belge/autre]. En cas de litige, et après tentative de recherche d'une solution amiable, compétence est attribuée aux tribunaux [de la ville de X].
      </p>
